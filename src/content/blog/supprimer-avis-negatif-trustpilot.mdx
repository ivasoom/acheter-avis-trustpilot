...
<Summary
  ...
  points={[
    "Dans quels cas précis Trustpilot peut supprimer un avis négatif",
    "La procédure officielle de contestation étape par étape",
    "Ce que vous ne devez surtout pas faire (erreurs qui aggravent la situation)",
    "Les stratégies alternatives quand la suppression est impossible",
    "Comment identifier et signaler une attaque coordonnée de faux avis"
  ]}
/>
...
<Checklist
  title="Signes d'un avis malveillant"
  items={[
    ...
    "Vague de plusieurs avis simultanés — 5 à 10 avis négatifs en quelques heures",
    "Même profil linguistique — plusieurs avis avec les mêmes tournures de phrase",
    "Avis très courts — 'Service nul' sans aucune explication"
  ]}
/>
...
<Steps steps={[
  { title: "Identifier l'avis problématique", description: "Avant de contester, assurez-vous que l'avis répond à un critère de suppression. Un avis négatif mais honnête ne peut pas être supprimé, même s'il est injuste ou exagéré. Posez-vous les questions clés : la personne a-t-elle été votre client ? L'avis contient-il des faits prouvables faux ? Y a-t-il des insultes ?" },
  { title: "Signaler l'avis via Trustpilot", description: "Connectez-vous à votre tableau de bord Trustpilot Business. Naviguez vers l'avis, cliquez sur 'Signaler cet avis', sélectionnez la raison, ajoutez une description détaillée et joignez vos preuves (captures d'écran, extraits CRM)." },
  { title: "Attendre la décision de Trustpilot", description: "Trustpilot examine généralement les signalements sous 3 à 10 jours ouvrables. Pendant ce temps, l'avis reste visible. Le taux de succès est d'environ 20 à 30% avec des preuves solides." },
  { title: "Faire appel si nécessaire", description: "Si Trustpilot rejette votre contestation, vous pouvez faire appel en fournissant des preuves supplémentaires. Trustpilot dispose d'un processus d'appel formel décrit dans leur centre d'aide." }
]} />
...
<Warning title="Actions à éviter absolument">
...
<CtaInline
  title="Noyez les avis négatifs dans un flot de positifs"
  description="Nos avis 100% français avec garantie 12 mois sont la solution la plus rapide pour rétablir votre note et protéger votre réputation."
...
<RelatedArticles articles={[
  ...
  { title: "Comment améliorer votre réputation en ligne", href: "/blog/comment-ameliorer-reputation-en-ligne", category: "Réputation" },
