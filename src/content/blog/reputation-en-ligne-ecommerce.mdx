...
<Summary points={[
  "Les 4 piliers de la réputation en ligne pour un e-commerce",
  "Comment les moteurs de recherche affichent votre réputation",
  "Stratégie multiplateforme : Trustpilot + Google Reviews",
  "Le coût financier d'une mauvaise réputation (chiffres réels)"
]} />
...
<StatRow stats={[
  { value: "72%", label: "des Français vérifient les avis avant d'acheter sur un site inconnu" },
  { value: "89%", label: "pour les achats > 100€" },
  { value: "31%", label: "de revenus en plus pour les entreprises bien notées", source: "McKinsey" },
  { value: "x10", label: "le ROI de la réputation vs acquisition payante" }
]} />
...
1. **Guides d'achat :** "Comment choisir votre [produit] en 2026" — montre votre expertise
...
<RoiBox items={[
  { label: "Acquisition Google Ads (même trafic)", value: "5 000€/mois" },
  { label: "Investissement réputation Trustpilot", value: "200 – 500€ (une fois)" },
  { label: "Impact sur le CA (équivalent)", value: "+5 400€/mois" },
  { label: "ROI de la réputation vs publicité", value: "10x à 25x", highlight: true }
]} />

<CtaInline
  title="Construisez votre réputation Trustpilot maintenant"
  description="Comptes 100% français, garantie 12 mois. Premier résultat visible en 48h."
  href="/#services"
  cta="Voir nos offres →"
/>
...
<RelatedArticles articles={[
  { title: "Avis Trustpilot et conversion : l'impact réel sur vos ventes", href: "/blog/avis-trustpilot-conversion-ventes", category: "Conversion" },
  ...
  { title: "Augmenter sa note Trustpilot", href: "/blog/augmenter-note-trustpilot", category: "Stratégie" }
]} />
